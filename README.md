...
- Timestamp: `2022-05-26 18:18`
- Build ID: `d53def92-ef90-49cf-84b2-aefc2ffb80b1`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d53def92-ef90-49cf-84b2-aefc2ffb80b1.git
$ cd d53def92-ef90-49cf-84b2-aefc2ffb80b1
```
